    ...
    <div className="flex flex-row-reverse h-screen font-sans text-gray-600">
      <aside className="bg-gray-800 text-white w-64">
        <div className="p-4">
          ...
          <ul>
            <li>
              <a href="/dashboard" className="flex items-center text-sm py-2 px-4 rounded hover:bg-gray-700">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
                داشبورد
              </a>
            </li>
            <li>
              <a href="/users" className="flex items-center text-sm py-2 px-4 rounded hover:bg-gray-700">
            ...
            <li>
              <a href="/products" className="flex items-center text-sm py-2 px-4 rounded hover:bg-gray-700">
